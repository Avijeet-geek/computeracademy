		...
		<div class="table-data">
			<table class="table table-hover">
				...
				<tbody>
					...
					<td>{{y.parent_slider}}</td>
						<td>{{y.title}}</td>
						<div class="col-sm-3" ng-show="x.image">
						<td class="img-responsive">
						<img ng-if="y.image && y.url_type=='0'" ng-src="<?=base_url()?>assets/website/uploads/slider_img/thumb/{{y.image}}" style="height: 50px">
						...
						<td>
						  <a href="javascript:void(0)" ng-click="update_call(y)" data-toggle="modal" data-target=".bs-example-modal-sm">
    						...
    						&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" ng-click="delete_data(y.slider_img_id)">
