			...
			<table class="table table-hover">
				...
				<tbody>
					<tr dir-paginate="y in datadb | filter: search_text | itemsPerPage: 5" >
						...
						<img ng-if="y.image && y.url_type=='0'" ng-src="<?=base_url()?>assets/website/uploads/service_head/thumb/{{y.image}}" style="height: 50px">
						...
						<td>
						  <a href="javascript:void(0)" ng-click="update(y)">
    						...
    						&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" ng-click="delete_data(y.s_id)">
