			...
			<table class="table table-hover">
				...
				<tbody>
					<tr dir-paginate="y in datadb | filter: search_text | itemsPerPage: 3" >
						...
						<img ng-if="y.image && y.url_type=='0'" ng-src="<?=base_url()?>assets/website/uploads/courses/thumb/{{y.image}}" style="height: 50px">
						...
						<td>
						  <a href="javascript:void(0)" ng-click="update_call(y)" data-toggle="modal" data-target=".bs-example-modal-sm">
    						...
    						&nbsp;&nbsp;&nbsp;<a href="javascript:void(0)" ng-click="delete_data(y.c_id)">
