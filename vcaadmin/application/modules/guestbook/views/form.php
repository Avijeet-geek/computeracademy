...
<div class="col-lg-12 well">
     <div class="col-sm-6">
         <form name="form1" id="form1" method="post" action="">
            ...
            <input type="text" name="id" ng-model="x.guest_id" hidden>
            ...
            <div class="col-lg-3" ng-show="x.image">
                <img ng-src="<?=base_url("assets/website/uploads/guestbook/thumb")?>/{{x.image}}" class="img-responsive" style="height:150px">
             </div>
         </div>
