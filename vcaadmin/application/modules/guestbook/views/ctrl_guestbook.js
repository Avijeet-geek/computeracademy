...
app.controller('ctrl_guestbook',function($scope,$http,$filter){
	...
	$http.get("guestbook/view_data").success(function(data){
		$scope.datadb=data;
	})
...
//	}
	...
	{
		$http.get("guestbook/delete_data?id="+x.guest_id).success(function(data){
			if(data=="1")
			{
