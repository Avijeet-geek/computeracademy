         ...
         <form name="form1" id="form1" method="post" action=""autocomplete="off">
          <input name="b_id" ng-model="x.b_id" hidden>
            ...
            <div class="clearfix"></div>
                ...
                <div class="col-sm-10">
                    <input name="title" class="form-control" ng-model="x.title"  required></div>
           ...
           <div class="col-sm-10">
                ...
                <div class="col-sm-10">
                    <input name="date" id="DOB1" class="form-control" ng-model="x.date"  required></div>
                ...
                <div class="col-sm-10">
                    <input name="time" class="form-control" ng-model="x.time"  required></div>
                ...
                <div class="col-sm-10">
                    <input name="author" class="form-control" ng-model="x.author"  required></div>
			...
			<img src="<?=base_url("assets/website/uploads/blog/thumb")?>/{{x.image}}"
