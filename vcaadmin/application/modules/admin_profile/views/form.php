     ...
     <div class="col-sm-12">
       <form action="" id="form1" method="post">
         <input name="id"  ng-model="y.id" hidden>
            ...
            <div class="col-sm-12 ">
                <div class="col-sm-6 ">
                    <label class="deco">Moto</label>
                    <input type="text" name="moto" class="form-control" ng-model="y.moto"   required style="width:400px;">               
                </div>
                <div class="col-sm-6 ">
                    <label class="deco">About Our company</label>
                    <textarea name="about" class="form-control" ng-model="y.about" style="width:400px; height:120px;"  required></textarea>               
                </div>
            </div>
            <div class="clearfix"></div><br>
            ...
            <div class="col-sm-12 ">
                <div class="col-sm-6 ">
                    <label class="deco">Global Header</label>
                     <textarea name="gheader" class="form-control" ng-model="y.gheader" style="width:400px; height:120px;"  required></textarea>                 
                </div>
                <div class="col-sm-6 ">
                    <label class="deco">Global Footer</label>
                    <textarea name="gfooter" class="form-control" ng-model="y.gfooter" style="width:400px; height:120px;"  required></textarea>               
                </div>
            </div>
            <div class="clearfix"></div><br>
