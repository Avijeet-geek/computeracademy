...
app.controller('ctrl_services',function($scope,$http,$filter){
	...
	$http.get("services/view_data").success(function(data){
		$scope.datadb=data;
	})
...
//	}
	...
	{
		$http.get("services/delete_data?id="+x.c_id).success(function(data){
			if(data=="1")
			{
