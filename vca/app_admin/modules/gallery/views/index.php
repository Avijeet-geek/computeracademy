...
<div class="col-sm-3">
 ...
 <br>
     ...
     <div class="input-group">
        ...
        <div class="input-group-addon warning" data-toggle="modal" data-target="#myModal" style="cursor:pointer"><span class="glyphicon glyphicon-plus"></span></div>
     </div>
      ...
      <div class="form-group col-sm-2" id="webprogress" style="display: none">
            <img src="<?=base_url("assets/website/images/progress/load1.gif")?>" class="img-responsive">
      </div>
 </form>
</div>
<div class="col-sm-9 gallery">
    ...
    <div  class="gallery_delete">
        ...
        <img ng-src="<?=base_url("assets/website/uploads/gallery/thumb")?>/{{x.image}}" style="height:180px" class="img-responsive">
        <a href="javascript:void(0)" ng-click="delete_data(x)" class="delete"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span></a>
    </div>
    </div>
    <div class="col-sm-12">
        <dir-pagination-controls boundary-links="true" on-page-change="pageChangeHandler(newPageNumber)" template-url="<?=site_url('template/pagination')?>" paginate-id="gallery"></dir-pagination-controls>
    </div>
</div>
