...
class Gallery extends MX_Controller
{
    ...
    function image_upload()
    {
        ...
        if ($this->form_validation->run() == TRUE) 
        {
            ...
            $config['new_image'] = './assets/website/uploads/gallery/';
            ...
            {   
                ...
                $config['source_image'] = './assets/website/temp/' . $image['file_name'];
                $config['new_image'] = './assets/website/uploads/gallery/thumb/';
                $config['file_name'] = $title . "_" . $rand_number . $timestamp;
                $config['maintain_ratio'] = TRUE;
...
//                     print_r($data);die();
    ...
    function delete_data()
    {
        if (isset($_GET['id']) && $_GET['id'])
        {
            ...
            {
                $image_delete_path1="./assets/website/uploads/gallery/$row->image";
                $image_delete_path2="./assets/website/uploads/gallery/thumb/$row->image";
            }
