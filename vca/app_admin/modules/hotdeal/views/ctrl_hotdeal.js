...
app.controller('ctrl_hotdeal',function($scope,$http,$filter){
	...
	$http.get("hotdeal/view_data").success(function(data){
		$scope.datadb=data;
	})
...
//	}
	...
	{
		$http.get("hotdeal/delete_data?id="+x.deal_id).success(function(data){
			if(data=="1")
			{
