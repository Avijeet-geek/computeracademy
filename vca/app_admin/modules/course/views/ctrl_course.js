...
app.controller('ctrl_course',function($scope,$http,$filter){
	...
	$http.get("course/view_data").success(function(data){
		$scope.datadb=data;
	})
...
//	}
	...
	{
		$http.get("course/delete_data?id="+x.c_id).success(function(data){
			if(data=="1")
			{
